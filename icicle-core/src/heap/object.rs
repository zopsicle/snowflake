...
///
/// These descriptions are not persisted in memory.
/// They just transfer some information
/// during object construction and inspection.
/// Hence we don't export this from the `heap` module.
pub (in super::super) struct Description<F>
...
impl Undef
{
    ...
    pub (in super::super) unsafe fn describe()
...
impl Boolean
{
    ...
    pub (in super::super) unsafe fn describe(value: bool)
        -> Description<impl FnOnce(NonNull<()>)>
    {
        Description{
            size: size_of::<Self>(),
...
impl String
{
    ...
    pub (in super::super) unsafe fn describe(len: usize)
        -> Description<impl FnOnce(NonNull<()>)>
    {
        Description{
